...
const navigationItems: NavItem[] = [
  ...
  },
  {
    ...
    hasDropdown: true,
    subItems: [
      { name: 'Live Trading Signals', href: '/dashboard/trading/signals' },
      { name: 'Performance Metrics', href: '/dashboard/trading/performance' },
      { name: 'Copy Trading', href: '/dashboard/trading/copy' },
      { name: 'Risk Management', href: '/dashboard/trading/risk' },
      { name: 'Follower Analytics', href: '/dashboard/trading/followers' },
    ],
  },
  {
